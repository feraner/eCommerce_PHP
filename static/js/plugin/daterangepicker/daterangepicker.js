...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            //this.separator = ' - ';
			this.separator = '/';
			if(typeof(ueeshop_config)!='undefined' && ueeshop_config.manage_language=='en'){	//后台英文版
				this.locale = {
					applyLabel: 'ok',
					cancelLabel: 'cancel',
					fromLabel: 'Start',
					...
					daysOfWeek: moment()._lang._enweekdaysMin.slice(),
					monthNames: moment()._lang._enmonthsShort.slice(),
					firstDay: 0
				};
			}else{
				this.locale = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="icon-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="icon-right"></i></th>';
            } else {
                html += '<th></th>';
            }
