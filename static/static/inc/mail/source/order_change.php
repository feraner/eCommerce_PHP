...
<div style="width:700px; margin:10px auto;">
	...
	<div style="font-family:Arial; padding:15px 0; line-height:150%; min-height:100px; _height:100px; color:#333; font-size:12px;">
        ...
        <?=str_replace('%oid%', '<a href="{OrderUrl}" target="_blank" style="color:#1E5494; text-decoration:underline; font-family:Arial; font-size:12px;">{OrderNum}</a>', $c['lang_pack_email']['changeInfo']);?><br /><br />
