...
<div id="what_hot" class="sidebar">
    ...
    <div class="b_list">
        <?php
        $row=str::str_code(db::get_limit('products', 'IsHot=1'.$c['where']['products'], '*', $c['my_order'].'ProId desc', 0, 5));
        ...
        <dl class="pro_item clearfix">
            ...
            <dd class="fl pro_info">
                ...
                <div class="pro_price"><em class="currency_data PriceColor"></em><span class="price_data PriceColor" data="<?=$price_ary[0];?>" keyid="<?=$v['ProId'];?>"></span></div>
            </dd>
        </dl>
        <?php }?>
    </div>
