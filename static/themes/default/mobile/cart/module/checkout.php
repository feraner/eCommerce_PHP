            ...
            <div class="txt" id="address_list">
				...
				?>
					...
					<div class="address_btn">
						...
						<a href="/<?=(int)$_SESSION['User']['UserId']?'account':'cart';?>/address/?Form=1&Shipping=1" class="btn_global btn add_address FontBgColor FontBorderColor"><em>+</em><?=$c['lang_pack']['mobile']['add_new_addr'];?></a>
					</div>
				<?php }else{?>
					<div class="address_btn">
