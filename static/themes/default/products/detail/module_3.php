...
<div itemscope itemtype="http://schema.org/Product" class="clearfix">
	...
	<div class="detail_right fr">
		...
		<div class="widget prod_info_price">
			...
			<?php if($c['config']['products_show']['Config']['pdf']){?><a class="prod_info_pdf" href="javascript:;"><em class="icon_pdf"></em><?=$c['lang_pack']['products']['pdf'];?></a><?php }?>
		</div>
...
<div class="clearfix">
	...
	<div class="prod_may_like clearfix">
		<div class="b_title"><span><?=$c['lang_pack']['products']['mayLike'];?></span></div>
		<div class="b_list">
			<?php
			if($TopCateId){
					$UId="0,{$TopCateId},";
			...
			?>
				<dl class="pro_item clearfix">
					<dt><a class="pic_box" href="<?=$url;?>"><img src="<?=ly200::get_size_img($v['PicPath_0'], '240x240');?>" title="<?=$v['Name'.$c['lang']];?>" alt="<?=$v['Name'.$c['lang']];?>" /><span></span></a></dt>
					<dd class="pro_name"><a href="<?=$url;?>" title="<?=$v['Name'.$c['lang']];?>"><?=str::cut_str($v['Name'.$c['lang']], 45);?>..</a></dd>
					<dd class="pro_price"><em class="currency_data PriceColor"><?=$_SESSION['Currency']['Symbol'];?></em><span class="price_data PriceColor" data="<?=$price_ary[0];?>" keyid="<?=$v['ProId'];?>"><?=cart::iconv_price($price_ary[0], 2);?></span></dd>
				</dl>
			<?php }?>
		</div>
	</div>
