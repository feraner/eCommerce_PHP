...
<!--<div id="inbox_popup">
    ...
    <div class="inbox_popup_param">
    	<div class="blank20"></div>
    	<div class="inbox_popup_img pic_box"><img src="<?=$products_row['PicPath_0']?>" /><span></span></div>
        <div class="inbox_popup_name"><?=$products_row['Name_en']?></div>
        <div class="clear"></div>
    </div>
    <div class="blank30"></div>
    <form action="/account/" method="post" name="inbox_popup_form" enctype="multipart/form-data">
    	<div class="inbox_popup_container">
        	<div class="inbox_popup_txt">Content:</div>
            <div class="inbox_popup_input"><textarea class="inbox_popup_form_textarea" notnull></textarea></div>
            <div class="clear"></div>
        </div>
        <div class="blank30"></div>
        <div class="inbox_popup_container">
        	<div class="inbox_popup_txt">Upload Image:</div>
            <div class="inbox_popup_input">
            	<div class="inbox_popup_upload">
                	<input class="upload_input" type="text" id="textfield" />
                    <input class="upload_button" type="button" value="Upload" />
                    <div class="clear"></div>
                    <input class="upload_file" type="file" name="PicPath" onchange="document.getElementById('textfield').value=this.value" />
                </div>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="inbox_popup_container">
            ...
            <input type="hidden" name="do_action" value="user.test">
        </div>
    </form>
</div>-->