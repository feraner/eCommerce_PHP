<?php !isset($c) && exit();?>
<div itemscope itemtype="http://schema.org/Product" class="detail_box clearfix">
	...
	<div class="detail_right fl">
		...
		<?php if($c['config']['products_show']['Config']['pdf']){?><div class="prod_info_combination"><a class="prod_info_pdf" href="javascript:;"><em class="icon_pdf"></em><?=$c['lang_pack']['products']['pdf'];?></a></div><?php }?>
				...
				?>
					<dl class="pro_item clearfix<?=$k+1==$len?' last':'';?>">
						...
						<dd class="fl pro_info">
							<strong><?=$c['lang_pack']['products']['only'];?><br /><em class="currency_data PriceColor"><?=$_SESSION['Currency']['Symbol'];?></em><span class="price_data PriceColor" data="<?=$price_ary[0];?>" keyid="<?=$v['ProId'];?>"><?=cart::iconv_price($price_ary[0], 2);?></span></strong><br /><br />
							<a href="<?=$url;?>"><?=$c['lang_pack']['products']['learnMore'];?></a>
						</dd>
					</dl>
				<?php }?>
			</div>
