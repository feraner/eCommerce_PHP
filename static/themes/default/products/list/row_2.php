...
<div id="prod_list" class="list prod_list clearfix">
	...
	?>
	<dl class="flat_pro_item pro_item fl clearfix<?=$k%2==0?' first':'';?>">
		<dt>
		...
		<dd class="desc_box">
			<div class="pro_name"><a href="<?=$url;?>" title="<?=$name;?>"><?=str::str_echo($name, 60, 0, '..');?></a></div>
			<div class="pro_price">
