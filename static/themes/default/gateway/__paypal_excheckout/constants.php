...
$API_Paypal_Url='https://www.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=';
/*
$HostName=$_SERVER['HTTP_HOST'];
$online=(substr_count($HostName, 'ueeshop') || substr_count($HostName, 'ly200'))?0:1;
$online=1;
if((int)$online==1){	
	//正式环境
	$API_EndPoint='https://api-3t.paypal.com/nvp';
...
define('API_USERNAME', $API_UserName);//'320006220_sandbox_api1.qq.com'
//define('API_USERNAME', 'sombrobert_api1.gmail.com');
...
define('API_PASSWORD', $API_Password);//'MF6K67XDLQ53LZXP'
//define('API_PASSWORD', 'RRM7JUK6346WP338');

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $API_Signature);//'A9o85XY7APPqIGCSCBb651V-vny9AZ-turgG0.-w7BmX1xahC.3N.4XF'
//define('API_SIGNATURE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AlKdW0hKv7g9AOpN6d9Q4OPpHONq');
/**
