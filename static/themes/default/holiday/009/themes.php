...
?>
<style>
#bodyer{background:url(<?=$theme_ary[0]['PicPath'];?>) no-repeat top center #fad522;}
.pro_list_0{background-image:url(<?=$theme_ary[2]['PicPath'];?>); background-position:6px 9px;}
.pro_list_1{background-image:url(<?=$theme_ary[3]['PicPath'];?>); background-position:1002px 9px;}
.pro_list_2{background-image:url(<?=$theme_ary[4]['PicPath'];?>); background-position:6px 9px;}
</style>
<div id="bodyer" class="full">
	<div id="main" class="wide">
		...
		<div class="holiday_discount">
			<div class="holiday_discount_head"<?=$theme_ary[1]['Url']?' onClick="window.open(\''.$theme_ary[1]['Url'].'\');"':'';?>><?=$theme_ary[1]['Title'];?></div>
		...
		<div class="pro_list pro_list_<?=$i;?>">
			...
			<?php
				echo (($k+1)%4==0 || ($k+1)==$pro_len)?'<div class="blank15"></div>':''; 
			}?>
		</div>
		<?php }?>
	</div>
