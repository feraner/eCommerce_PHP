<?php !isset($c) && exit();?>
<?php
$login_module_ary=array('checkout', 'buynow', 'ajax_get_coupon_info', 'remove_coupon', 'placeorder', 'complete', 'success');	//需要登录的模块列表
...
echo ly200::load_static('/static/themes/default/css/cart_old.css', "/static/themes/{$c['theme']}/css/cart_old.css", '/static/themes/default/js/cart_old.js', '/static/js/plugin/tool_tips/tool_tips_web.js');
...
<div id="main" class="wide"><?=$cart_page_contents;?></div>
