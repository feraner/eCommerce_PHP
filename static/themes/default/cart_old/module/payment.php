...
if(@substr_count($method_path, 'globebill')){
	...
	//$form_action='https://payment.globebill.com/Interface';//支付网关
	$form_action='https://pay.asiabill.com/Interface';

	//$PaymentUrl='https://payment.globebill.com/TestInterface';	//测试网关
	//$PaymentUrl='https://payment.globebill.com/Interface';	//正式网关
	//$PaymentUrl='https://pay.securesslgateway.com/interface';	//最新网关
	//$PaymentUrl='https://pay.securesslgateway.com/Interface';	//最新测试网关
}
